...
import com.yfvesh.tm.ttsservice.ITts;
...
public class TextToSpeech {
    ...
    private void initTts() {
        ...
        Intent intent = new Intent("com.yfvesh.tm.ttsservice.TTS_SERVICE");
    ...
    public int pause() {
        synchronized (mStartLock) {
            int defaultsReturn = -1;
            if (!mStarted) {
                return defaultsReturn;
            }
            try {
                defaultsReturn = mITts.pause();
            } catch (RemoteException e) {
                // TTS died; restart it.
                Log.e("TextToSpeech.java - areDefaultsEnforced", "RemoteException");
                e.printStackTrace();
