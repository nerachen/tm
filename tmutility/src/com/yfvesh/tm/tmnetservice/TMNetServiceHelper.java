...
public final class TMNetServiceHelper {
	...
	private ITMSrvStatusLstnr mTMStatusLstnr;

	public TMNetServiceHelper(Context ctx) {
		mCtx = ctx;
	}
	
	public TMNetServiceHelper(Context ctx, ITMSrvStatusLstnr lstnr) {
		mCtx = ctx;
		mTMStatusLstnr = lstnr;
	}
	
	public void setTMSrvStatusLstnr(ITMSrvStatusLstnr lstnr) {
		mTMStatusLstnr = lstnr;
	}
	...
	private class RemoteServiceConnection implements ServiceConnection {
		public void onServiceConnected(ComponentName className,
			...
			if(mTMStatusLstnr!=null) {
				mTMStatusLstnr.onTMSrvConnected();
			}
		...
		public void onServiceDisconnected(ComponentName className) {
			...
			mRemoteTMConn = null;
			if(mTMStatusLstnr!=null) {
				mTMStatusLstnr.onTMSrvDisconnected();
			}
