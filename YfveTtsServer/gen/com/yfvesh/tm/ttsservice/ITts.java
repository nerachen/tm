 ...
 * Original file: D:\\telematics_for_yfve\\YfveTtsServer\\src\\com\\yfvesh\\tm\\ttsservice\\ITts.aidl
 */
package com.yfvesh.tm.ttsservice;
public interface ITts extends android.os.IInterface
{
/** Local-side IPC implementation stub class. */
public static abstract class Stub extends android.os.Binder implements com.yfvesh.tm.ttsservice.ITts
{
private static final java.lang.String DESCRIPTOR = "com.yfvesh.tm.ttsservice.ITts";
...
/**
 * Cast an IBinder object into an com.yfvesh.tm.ttsservice.ITts interface,
 * generating a proxy if needed.
 */
public static com.yfvesh.tm.ttsservice.ITts asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = (android.os.IInterface)obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof com.yfvesh.tm.ttsservice.ITts))) {
return ((com.yfvesh.tm.ttsservice.ITts)iin);
}
return new com.yfvesh.tm.ttsservice.ITts.Stub.Proxy(obj);
}
...
java.lang.String _arg0;
_arg0 = data.readString();
com.yfvesh.tm.ttsservice.ITtsCallback _arg1;
_arg1 = com.yfvesh.tm.ttsservice.ITtsCallback.Stub.asInterface(data.readStrongBinder());
...
private static class Proxy implements com.yfvesh.tm.ttsservice.ITts
{
...
public int registerCallback(java.lang.String callingApp, com.yfvesh.tm.ttsservice.ITtsCallback cb) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
int _result;
...
public int unregisterCallback(java.lang.String callingApp, com.yfvesh.tm.ttsservice.ITtsCallback cb) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
int _result;
...
static final int TRANSACTION_setSpeechRate = (android.os.IBinder.FIRST_CALL_TRANSACTION + 2);
static final int TRANSACTION_setPitch = (android.os.IBinder.FIRST_CALL_TRANSACTION + 3);
static final int TRANSACTION_speak = (android.os.IBinder.FIRST_CALL_TRANSACTION + 4);
static final int TRANSACTION_isSpeaking = (android.os.IBinder.FIRST_CALL_TRANSACTION + 5);
static final int TRANSACTION_stop = (android.os.IBinder.FIRST_CALL_TRANSACTION + 6);
static final int TRANSACTION_addSpeech = (android.os.IBinder.FIRST_CALL_TRANSACTION + 7);
static final int TRANSACTION_addSpeechFile = (android.os.IBinder.FIRST_CALL_TRANSACTION + 8);
static final int TRANSACTION_getLanguage = (android.os.IBinder.FIRST_CALL_TRANSACTION + 9);
static final int TRANSACTION_isLanguageAvailable = (android.os.IBinder.FIRST_CALL_TRANSACTION + 10);
static final int TRANSACTION_setLanguage = (android.os.IBinder.FIRST_CALL_TRANSACTION + 11);
static final int TRANSACTION_synthesizeToFile = (android.os.IBinder.FIRST_CALL_TRANSACTION + 12);
static final int TRANSACTION_playEarcon = (android.os.IBinder.FIRST_CALL_TRANSACTION + 13);
static final int TRANSACTION_addEarcon = (android.os.IBinder.FIRST_CALL_TRANSACTION + 14);
static final int TRANSACTION_addEarconFile = (android.os.IBinder.FIRST_CALL_TRANSACTION + 15);
static final int TRANSACTION_registerCallback = (android.os.IBinder.FIRST_CALL_TRANSACTION + 16);
static final int TRANSACTION_unregisterCallback = (android.os.IBinder.FIRST_CALL_TRANSACTION + 17);
static final int TRANSACTION_playSilence = (android.os.IBinder.FIRST_CALL_TRANSACTION + 18);
static final int TRANSACTION_setEngineByPackageName = (android.os.IBinder.FIRST_CALL_TRANSACTION + 19);
static final int TRANSACTION_getDefaultEngine = (android.os.IBinder.FIRST_CALL_TRANSACTION + 20);
static final int TRANSACTION_areDefaultsEnforced = (android.os.IBinder.FIRST_CALL_TRANSACTION + 21);
}
public int pause() throws android.os.RemoteException;
public int resume() throws android.os.RemoteException;
public int setSpeechRate(java.lang.String callingApp, int speechRate) throws android.os.RemoteException;
